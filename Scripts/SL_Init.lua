	...
	__index = {
		initialize = function(self)
			self.ActiveModifiers = {
				JudgmentGraphic = "Love 2x6.png", --not used right now
				Mini = "0%",
				ScreenFilter = 0, --It's actually a screenfilter
				DetailedPrecision = "Off",
				SpeedModType = "x",
				SpeedMod = 1.00,
				Vocalization = "None",
				NoteSkin = nil,
				...
				Pacemaker = false,
				ReceptorArrowsPosition = "StomperZ", --Not used either
